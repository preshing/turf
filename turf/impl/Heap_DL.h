...
TURF_DLL_ENTRY void* dlmalloc(size_t, mstate);
TURF_DLL_ENTRY void dlfree(void*, mstate);
TURF_DLL_ENTRY void* dlcalloc(size_t, size_t, mstate);
TURF_DLL_ENTRY void* dlrealloc(void*, size_t, mstate);
TURF_DLL_ENTRY void* dlrealloc_in_place(void*, size_t, mstate);
TURF_DLL_ENTRY void* dlmemalign(size_t, size_t, mstate);
TURF_DLL_ENTRY int dlposix_memalign(void**, size_t, size_t, mstate);
TURF_DLL_ENTRY void* dlvalloc(size_t, mstate);
TURF_DLL_ENTRY int dlmallopt(int, int, mstate);
TURF_DLL_ENTRY size_t dlmalloc_footprint(mstate);
TURF_DLL_ENTRY size_t dlmalloc_max_footprint(mstate);
TURF_DLL_ENTRY size_t dlmalloc_footprint_limit(mstate);
TURF_DLL_ENTRY size_t dlmalloc_set_footprint_limit(size_t bytes, mstate);
TURF_DLL_ENTRY void** dlindependent_calloc(size_t, size_t, void**, mstate);
TURF_DLL_ENTRY void** dlindependent_comalloc(size_t, size_t*, void**, mstate);
TURF_DLL_ENTRY size_t dlbulk_free(void**, size_t n_elements, mstate);
TURF_DLL_ENTRY void* dlpvalloc(size_t, mstate);
TURF_DLL_ENTRY int dlmalloc_trim(size_t, mstate);
TURF_DLL_ENTRY void dlmalloc_stats(mstate, Stats&);
TURF_DLL_ENTRY size_t dlmalloc_usable_size(void*);
//-----------------------------------------------------
